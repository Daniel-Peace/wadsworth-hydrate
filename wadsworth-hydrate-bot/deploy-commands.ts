...
for (const file of commandFiles) {
    ...
    if ('data' in command && 'execute' in command) {
        ...
        console.log(`[WARNING] The command at ${filePath} is missing either the data or execute attribute`);
    }
}
...
function deploy_to_test(commands: RESTPostAPIApplicationCommandsJSONBody[]): void {
...
function deploy_to_prod(commands: RESTPostAPIApplicationCommandsJSONBody[]): void {
